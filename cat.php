				...
				<div class="">
					...
					<div class="product-sec1 px-sm-4 px-3 py-sm-5  py-3 mb-4">
						...
						<div class="row">
							...
							$sql = "SELECT * FROM shopping WHERE cate = :cate  LIMIT $offset,$limit";
						...
						<nav aria-label="..." style="margin-top: 10px">
							...
							?>
								<ul class="pagination">
									...
									if ($page > 1) { ?>
										<li class="page-item ">
											<a class="page-link" href="cat.php?page=<?php echo ($page - 1); ?>" &cid=<?php echo $cate; ?>>Previous</a>
										</li>
									<?php }
									?>
									...
									?>
										<li class="page-item <?php echo $active ?>"><a class="page-link" href="cat.php?page=<?php echo $i ?>&cid=<?php echo $cate; ?>"><?php echo $i ?></a></li>
									<?php    }
									?>
									...
									if ($page < $total_page) { ?>
										<li class="page-item ">
											<a class="page-link" href="cat.php?page=<?php echo ($page + 1); ?>&cid=<?php echo $cate; ?>">Next</a>
										</li>
									<?php }
									?>
								</ul>
