	...
	<div class="banner-bootom-w3-agileits py-5">
		<div class="container py-xl-4 py-lg-2">
			...
			if (isset($_REQUEST['buynow'])) {
				$id = $_REQUEST['id'];
				$item_quant = $_REQUEST['item_quantity'];
			...
			?>
						...
						<div class="row">
							...
							<div class="col-lg-7 single-right-left simpleCart_shelfItem">
								...
								<p class="mb-3">
									<span class="item_price">$<?php $total_price = ($item_quant * $row['price']);
																echo $total_price;
																?></span>
								...
								<div class="occasion-cart">
									<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
										<form action="buyfinal.php" method="post">
											<fieldset>
												...
												<input type="submit" name="buyfinal" value="Buy Now" class="button btn" />
											</fieldset>
										</form>
									</div>
								</div>
